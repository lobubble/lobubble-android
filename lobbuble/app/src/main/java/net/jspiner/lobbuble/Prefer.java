 ...
 * @since 17. 2. 25
 *
 * 'net.jspiner.lobbuble.Prefer' is an advanced android sharedpreference library.
 *
 * Example
 *
 * net.jspiner.lobbuble.Prefer.set("user_int_state", 1);
 * int userState = net.jspiner.lobbuble.Prefer.get("user_int_state", 0);
 *
 * net.jspiner.lobbuble.Prefer.set("user_name", "john smith");
 * String userName = net.jspiner.lobbuble.Prefer.get("user_name", "none");
 *
 * net.jspiner.lobbuble.Prefer.set("enable_push_noti", true);
 * Boolean pushEnable = net.jspiner.lobbuble.Prefer.get("enable_push_noti", false);
 *
